...
echo [1/3] Launching Qwen3-TTS Server (Port 23015)...
start "QwenTTS-Server" run_qwen3_tts.bat

echo Waiting for TTS server to initialize...
timeout /t 10

echo [2/3] Launching MCP Server (Port 23016)...
...
echo.
echo  - TTS Server: http://localhost:23015
echo  - MCP Server: http://localhost:23016/mcp
